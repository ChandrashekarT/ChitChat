...
//  ChitChat
//
//  Created by Epos Admin on 21/03/18.
...
class ActivityViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    */
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        ...
        var cell : ActivityCell! = tableView.dequeueReusableCell(withIdentifier: cellIdentifier) as? ActivityCell
        if cell == nil {
            let nib = UINib.init(nibName: "ActivityCell", bundle: nil)
            tableView.register(nib, forCellReuseIdentifier: cellIdentifier)
            cell = tableView.dequeueReusableCell(withIdentifier: cellIdentifier) as! ActivityCell
    ...
    {
        let viewController = self.storyboard?.instantiateViewController(withIdentifier: "CallDetailsViewController")
